package com.zxyw.sdk.videoTalk.database;
...
import com.zxyw.sdk.videoTalk.utils.CoreDBManager;
...
public class CoreDB implements IEventListener {
    public static String APP_DB_PATH = "/data/data/com.zxyw.videotalktest/";
    ...
    public CoreDB(Context context){
        ...
        coreDBM.initCoreDB(context.getDatabasePath("coredb_" + MLOC.userId).getAbsolutePath());
        //历史表
